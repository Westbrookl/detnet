...
while [[ $FDN -le $U ]];do
	...
	FLOW_1_TX=$(cat $DIR/flow_stats.dat | grep "TX bitrate" | head -n1 | awk '{print $3}')
	FLOW_1_RX=$(cat $DIR/flow_stats.dat | grep "RX bitrate" | head -n1 | awk '{print $3}')
	FLOW_2_TX=$(cat $DIR/flow_stats.dat | grep "TX bitrate" | tail -n1 | awk '{print $3}')
	FLOW_2_RX=$(cat $DIR/flow_stats.dat | grep "RX bitrate" | tail -n1 | awk '{print $3}')
